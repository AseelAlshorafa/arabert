...
arabert_preprocessor = ArabertPreprocessor('aragpt2-base')
...
def main(_):
    ...
    gpt2_tok = GPT2TokenizerFast.from_pretrained("aubmindlab/aragpt2-base")
        ...
        with tf.gfile.GFile(input_file, "r") as reader:
            for line in reader.readlines():
                if line == "\n":
                    ...
                    line = line.replace("\n", " ")
                    line = arabert_preprocessor.preprocess(line)
                    line = line.strip()
